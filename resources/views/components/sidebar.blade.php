        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('dashboard.index') }}"
                    ...
                    {!! file_get_contents(public_path('storage\img\icons\grid.svg')) !!}
            ...
            <li>
                <a href="{{ route('registrations.index') }}"
                    class="flex items-center p-2 text-gray-50 rounded-lg hover:bg-blue-800 group capitalize">
                    {!! file_get_contents(public_path('storage\img\icons\calendar.svg')) !!}
            ...
            <li>
                <a href="{{ route('history.index') }}"
                    class="flex items-center p-2 text-gray-50 rounded-lg hover:bg-blue-800 group capitalize">
                    {!! file_get_contents(public_path('storage\img\icons\clock.svg')) !!}
            ...
            <li>
                <a href="{{ route('setting') }}"
                    class="flex items-center p-2 text-gray-50 rounded-lg hover:bg-blue-800 group capitalize">
                    {!! file_get_contents(public_path('storage\img\icons\settings.svg')) !!}
            ...
            <li>
                <a href="{{ route('logout') }}"
                    class="flex items-center p-2 text-gray-50 rounded-lg hover:bg-blue-800 group capitalize">
                    {!! file_get_contents(public_path('storage\img\icons\log-out.svg')) !!}
